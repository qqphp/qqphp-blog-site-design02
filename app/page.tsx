...
export default function Home() {
  return <main className="site-shell"><SiteHeader />
    <section className="hero hero-live" id="top"><div className="hero-copy"><p className="eyebrow">PERSONAL WORKSTATION / 2026</p><h1>思考、制作，<br />并留下值得回看的东西。</h1><div className="hero-bottom"><p>这里存放我的写作、项目与尚未成形的灵感。<br />欢迎从最近的更新开始。</p><Link className="round-link" href="/writing" aria-label="查看最近更新">↓</Link></div></div><HeroGarden /></section>
