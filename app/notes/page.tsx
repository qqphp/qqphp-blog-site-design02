...
export default function StoriesPage() {
  ...
  return <main className="site-shell"><SiteHeader />
    <section className="story-top"><StoryCover /><div className="story-profile"><div className="story-avatar">A</div><div><h1>开发阿雷</h1><p>记录正在发生的事，也保留还没有答案的问题。</p></div></div></section>
