...
export default function AboutPage() {
  return <main className="site-shell about-page"><SiteHeader />
    <section className="about-signal"><div className="signal-stamp">PERSONAL<br />SIGNAL<br />FIELD</div><p className="eyebrow">你好，我是开发阿雷</p><h1>把模糊的事，<br />慢慢做得清楚。</h1><p className="signal-caption">内容、体验、工作流，以及那些值得被留下的过程。</p><div className="signal-orbit" aria-hidden="true"><i /><b>◌</b><em>01</em></div></section>
