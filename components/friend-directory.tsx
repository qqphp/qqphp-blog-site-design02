...
export function FriendDirectory() {
  ...
  return <div className="directory-page friends-page">
    ...
    <div className="friends-note"><span className="friends-note-symbol" aria-hidden="true">✳</span><p>{"这里为认真记录的人留一个位置。"}<small>当前 {friends.length}{" 张名片。"}</small></p><span className="friends-note-index" aria-hidden="true">{"PERSONAL"}<br />{"WEB DIRECTORY"}</span></div>
