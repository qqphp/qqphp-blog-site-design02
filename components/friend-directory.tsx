...
export function FriendDirectory() {
  ...
  return <div className="directory-page friends-page">
    ...
    <div className="friends-note"><span className="friends-note-symbol" aria-hidden="true">✳</span><p><CmsText page="友链页" name="05 这里为认真记录的人留一个位置。" /><small>当前 {friends.length}<CmsText page="友链页" name="06 张名片均为虚构示例，真实友链待补充。" /></small></p><span className="friends-note-index" aria-hidden="true"><CmsText page="友链页" name="07 PERSONAL" /><br /><CmsText page="友链页" name="08 WEB DIRECTORY" /></span></div>
